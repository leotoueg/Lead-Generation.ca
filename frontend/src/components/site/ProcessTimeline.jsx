        ...
        <div ref={ref} className="relative mt-16 pl-2">
          ...
          <div className="space-y-10 sm:space-y-14">
            {STEPS.map((step, i) => (
              ...
              >
                <div className="relative z-10 flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl border border-white/10 bg-ink-900 shadow-[0_0_30px_-10px_rgba(44,92,229,0.8)]">
