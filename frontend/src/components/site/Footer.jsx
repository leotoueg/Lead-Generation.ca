    ...
    <footer className="relative border-t border-white/10 bg-black" data-testid="site-footer">
      <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8">
        <div className="flex flex-col items-start justify-between gap-10 sm:flex-row sm:items-center">
          <div>
            <img src="/cherrytree-logo.png" alt="Cherry Tree Agency" className="h-9 w-auto" />
        ...
        <div className="mt-14 flex flex-col items-start justify-between gap-4 border-t border-white/10 pt-8 sm:flex-row sm:items-center">
          <p className="text-xs text-white/35">© {new Date().getFullYear()} Cherry Tree Agency. All rights reserved.</p>
