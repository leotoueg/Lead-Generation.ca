      ...
      {show && (
        ...
        >
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-full bg-gradient-to-b from-white to-[#c2c6cd] px-8 py-4 text-sm font-bold uppercase tracking-[0.14em] text-black shadow-[0_0_40px_-12px_rgba(255,255,255,0.6)]"
          >
