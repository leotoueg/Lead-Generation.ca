  ...
  <section className="relative py-12 sm:py-16" data-testid={testid}>
    <div className="mx-auto max-w-7xl px-5 sm:px-8">
      <motion.div
        ...
        className="relative overflow-hidden rounded-3xl border border-[#285EE0]/30 bg-gradient-to-r from-[#285EE0]/[0.14] via-white/[0.02] to-transparent px-6 py-10 sm:px-12"
      >
        <div className="pointer-events-none absolute -right-24 -top-24 h-72 w-72 rounded-full bg-[#285EE0]/25 blur-[100px]" />
